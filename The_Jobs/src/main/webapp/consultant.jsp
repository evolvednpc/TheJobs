...
<html lang="en">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link active" href="consultant.jsp">Consultants</a>
        ...
        <div class="container h-contact-container">
            <h2 class="text-white">Our Consultants</h2>
            <p class="text-colour">
        ...
        <div class="container gallery-container">
            <div class="card">
                <img
                    ...
                    />
                <div class="card-body">
                    <h5 class="card-title">Mr. Nihal Kariyawasam</h5>
                    <p class="card-text">
                        “Worked at Sri Lanka’s top consulting agencies, He is available from Monday to Wednesday from 9.00 a.m to 5.00 p.m and again on Friday to Sunday from 9.00 a.m to 5.00 p.m.”
                    </p>
                </div>
            </div>
            <div class="card">
                <img
                    ...
                    />
                <div class="card-body">
                    <h5 class="card-title">Mr. Senarath Gunasingha</h5>
                    <p class="card-text">
                        “Worked at Sri Lanka’s top consulting agencies, He is available from Monday to Wednesday from 9.00 a.m to 5.00 p.m and again on Friday to Sunday from 9.00 a.m to 5.00 p.m.”
                    </p>
                </div>
            ...
            <div class="card">
                <img
                    ...
                    />
                <div class="card-body">
                    <h5 class="card-title">Mrs. Mrs. Roshini Buddikochara</h5>
                    <p class="card-text">
                        “Worked at Sri Lanka’s top consulting agencies, She is available from Wednesday to Thursday from 9.00 a.m to 5.00 p.m and again on Sunday to Monday from 9.00 a.m to 5.00 p.m.”
                    </p>
                </div>
            </div>
            <div class="card">
                <img
                    ...
                    />
                <div class="card-body">
                    <h5 class="card-title">Mrs. Megan Fox</h5>
                    <p class="card-text">
                        "Posses a masters degree in Human Resource, She is available from Wednesday to Thursday from 9.00 a.m to 5.00 p.m and again on Sunday to Monday from 9.00 a.m to 5.00 p.m."
                    </p>
                </div>
            </div>
        </div>
